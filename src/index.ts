        ...
        try {
            ...
            switch (request.params.name) {
                ...
                case 'slack_post_message': {
                    const args = request.params
                        .arguments as unknown as PostMessageArgs;
                ...
                case 'slack_add_reaction': {
                    const args = request.params
                        .arguments as unknown as AddReactionArgs;
                ...
                case 'slack_get_users': {
                    const args = request.params
                        .arguments as unknown as GetUsersArgs;
                ...
                case 'slack_get_user_profile': {
                    ...
                    const response = await slackClient.getUserProfile(
                        args.user_id,
                    );
                    return {
                        content: [
...
app.listen(PORT, HOST, (error) => {
    if (error) {
        ...
        console.info('Server is running on http://%s:%d', HOST, PORT);
    }
});
